 ...
 * Helper for mod_eiko_articles_news
...
abstract class ModEikoArticlesNewsHelper
...

	{
...

		{
...

			{
				...
				$item->linkText = JText::_('MOD_EIKO_ARTICLES_NEWS_READMORE');
...

			{
				...
				$item->linkText = JText::_('MOD_EIKO_ARTICLES_NEWS_READMORE_REGISTER');

			}



			$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'mod_eiko_articles_news.content');
